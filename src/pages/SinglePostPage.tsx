...
const SinglePostPage = () => {
  const data = {
    id: 1,
    title: "Post1",
    user: { username: "John Doe", img: "shortView/userImg.jpeg" },
    category: "Technology",
    createdAt: new Date("2022-01-01"),
    content:
      "Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam neque fugiat itaque quas esse sunt cupiditate possimus cumque asperiores, dolorem, dolores eligendi amet perferendis illum repellat nam quam.",
      ...
      <div className="flex gap-8">
        <div className="lg:w-3/5 flex flex-col gap-8">
          ...
          <div className="flex items-center gap-2 text-gray-400 text-sm">
            ...
            <span>on</span>
            <Link to={data.category} className="text-blue-800">
              {data.category}
            </Link>
        ...
        <div className="px-4 h-max sticky top-8">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex items-center gap-8">
              ...
              <Link to={data.user.username} className="text-blue-800">
                {data.user.username}
              </Link>
            </div>
